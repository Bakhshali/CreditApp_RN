...
const RangeFilter = ({ navigation }: any) => {
  ...
  const handleTextInputChangeMonth = (text: any) => {
    const newValueMonth = parseInt(text) || 0;
    setValueMonth(newValueMonth);
    AsyncStorage.setItem('dataMonth', newValueMonth.toString());
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={{ flex: 5, marginHorizontal: 20, gap: 20 }}>
        <View>
          <Text style={styles.regSty}>Müraciət</Text>
        </View>
        <View>
      ...
      <View style={{ flex: 1, marginHorizontal: 15 }}>
        <View style={{ width: '100%', backgroundColor: '#155eef', padding: 18, borderRadius: 10 }}>
          <TouchableOpacity onPress={() => navigation.navigate('AcceptScreen')}>
